...
CREATE TABLE `hi_system_module` (
  ...
  `intro` varchar(255) COMMENT '模块简介',
  ...
  `app_keys` varchar(80) DEFAULT '' COMMENT '应用秘钥',
...
CREATE TABLE `hi_system_plugin` (
  ...
  `intro` varchar(255) COMMENT '插件简介',
  `author` varchar(32) NOT NULL COMMENT '作者',
  `url` varchar(255) NOT NULL COMMENT '作者主页',
  `version` varchar(16) NOT NULL DEFAULT '' COMMENT '版本号',
  `identifier` varchar(64) NOT NULL DEFAULT '' COMMENT '插件唯一标识符',
  `app_id` varchar(30) NOT NULL DEFAULT '' COMMENT '应用市场ID',
  `app_keys` varchar(80) DEFAULT '' COMMENT '应用秘钥',
  `theme` varchar(50) DEFAULT 'default' COMMENT '电脑端主题',
  `mobile_theme` varchar(50) DEFAULT 'default' COMMENT '手机web主题',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
