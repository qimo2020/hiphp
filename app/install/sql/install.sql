...
CREATE TABLE `hi_system_annex` (
  ...
  `group` varchar(100) NOT NULL DEFAULT 'system' COMMENT '文件分组',
...
VALUES
  ...
  ('31', '1', 'system', '页面Trace', 'app_trace', '0', 'switch', '0:关闭\r\n1:开启', '', '&lt;strong class=&quot;red&quot;&gt;生产环境下一定要关闭此配置&lt;/strong&gt;', '4', '1', '1573109710', '1573109779'),
  ...
  ('50', '1', 'system', '云端推送', 'cloud_push', '1', 'switch', '0:关闭\r\n1:开启', '', '关闭之后，无法通过云端推送安装扩展', '5', '1', '1573109710', '1573109779'),
  ('51', '1', 'base', '手机网站域名', 'mobile_domain', '', 'input', '', '', '手机访问将自动跳转至此域名，示例：http://m.domain.com', '2', '1', '1573109710', '1573109779'),
  ('52', '1', 'system', '多语言支持', 'multi_language', '0', 'switch', '0:关闭\r\n1:开启', '', '开启后你可以自由上传多种语言包', '6', '1', '1573109710', '1573109779'),
  ('53', '1', 'system', '后台白名单验证', 'admin_whitelist_verify', '0', 'switch', '0:禁用\r\n1:启用', '', '禁用后不存在的菜单节点将不在提示', '7', '1', '1573109710', '1573109779'),
  ('54', '1', 'system', '系统日志保留', 'log_retention', '30', 'input', '', '', '单位天，系统将自动清除 ? 天前的系统日志', '8', '1', '1573109710', '1573109779'),
  ('55', '1', 'upload', '上传驱动', 'driver', 'local', 'select', 'local:本地上传', '', '资源上传驱动设置', '0', '1', '1573109710', '1573109779'),
  ('56', '1', 'system', '扩展配置分组', 'config_group', '', 'array', ' ', '', '请按如下格式填写：&lt;br&gt;键值:键名&lt;br&gt;键值:键名&lt;br&gt;&lt;span style=&quot;color:#f00&quot;&gt;键值只能为英文、数字、下划线&lt;/span&gt;', '2', '0', '1573109710', '1573109779');
...
VALUES
  ...
  (4,0,'hi_builder','plugin.builder','后台开发构建器',1,1579153029,1579153029);
...
VALUES
 (1, 'hi_builder', 'builder', '0', '1', '1579141935', '1579141935');
...
CREATE TABLE `hi_system_menu` (
  ...
  `module` varchar(20) NOT NULL COMMENT '模块名或插件名，插件名格式:plugin.插件名',
...
('16', '8', 'system', '钩子管理', 'icon iconfont iconlink', 'system/hook/index', '', '_self', '3', '0', '1', '1', '1573109779'),
('17', '8', 'system', '本地模块', 'icon iconfont iconmodule', 'system/module/index', '', '_self', '0', '0', '1', '1', '1573109779'),
('18', '17', 'system', '导入模块', '', 'system/module/import', '', '_self', '0', '0', '1', '1', '1573109779'),
('19', '8', 'system', '本地插件', 'icon iconfont iconplugin', 'system/plugin/index', '', '_self', '1', '0', '1', '1', '1573109779'),
...
CREATE TABLE `hi_system_plugin` (
  ...
  `app_keys` varchar(200) DEFAULT '' COMMENT '应用秘钥',
  `theme` varchar(50) NOT NULL DEFAULT 'default' COMMENT '电脑端主题',
  `mobile_theme` varchar(50) NOT NULL COMMENT '手机web主题',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
...
VALUES
  (1, 0, 'builder', '构建器', '', 'HiPHP构建器', 'HiPHP', 'http://www.hiphp.net', '1.0.0', 'builder.hi.plugin', '', '', '', '', 1579153755, 1579153755, 0, 2);
