...
class Error extends Common
{
    ...
    private function step5()
    {
            ...
            if ($sqlList) {
                ...
                foreach ($sqlList as $v) {
                    try {
                        ...
                        return $this->response(0,'请启用InnoDB数据引擎，并检查数据库是否有DROP和CREATE权限');
                    }
                }
            }
        }
        ...
        return $this->response(1, '恭喜您！系统安装成功，稍后将自动跳转至后台(/admin.php)', $rootDir . 'admin.php');
    }
